...
def integrateode():
  ...
  r.set_initial_value([R_t_zero,P_t_zero,C3F1_t_zero,F1_t_zero,C3nuc_t_zero,X1_t_zero,X2_t_zero,XB_t_zero,s_init],t_s)
...
def main():
  ...
  if s == 0:
    ...
    XB_t_zero = 0.0001
    s_init    = 0
    t_int     = 120.0 #Time of integration
    Z=[R_t_zero,P_t_zero,C3F1_t_zero,F1_t_zero,C3nuc_t_zero,X1_t_zero,X2_t_zero,XB_t_zero,s_init,t_int]
    odeintegrate(Z)
